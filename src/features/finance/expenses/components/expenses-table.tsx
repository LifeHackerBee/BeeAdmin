...
export function ExpensesTable({ data }: DataTableProps) {
  ...
  const {
    ...
    columnFilters: [
      ...
      { columnId: 'currency', searchKey: 'currency', type: 'array' },
    ],
  })
  ...
  const table = useReactTable({
    ...
    globalFilterFn: (row, _columnId, filterValue) => {
      ...
      const deviceName = String(row.getValue('device_name') || '').toLowerCase()
      const searchValue = String(filterValue).toLowerCase()

      return id.includes(searchValue) || note.includes(searchValue) || deviceName.includes(searchValue)
    },
